...
def index(request):
    ...
    return render_to_response('portfolio/index.djhtml', {"project_year_list" : project_year_list, "project_content_list" : project_content_list})
...
def article(request, project_name, article_name):
    ...
    if os.path.isfile(article_path):
        with open(article_path, "r") as f:
            content_body = markdown.markdown(f.read())
    return render_to_response('portfolio/article.djhtml', {"project" : project, "content_body": content_body })
